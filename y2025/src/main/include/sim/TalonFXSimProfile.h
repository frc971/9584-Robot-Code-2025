...
class TalonFXSimProfile : public SimProfile {
  static constexpr units::ohm_t kMotorResistance =
      2_mOhm;  // Assume 2mOhm resistance for voltage drop calculation
 ...
 public:
   ...
   */
  TalonFXSimProfile(ctre::phoenix6::hardware::TalonFX& talonFX,
                    units::kilogram_square_meter_t rotorInertia);
