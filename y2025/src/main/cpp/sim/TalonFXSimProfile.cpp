...
TalonFXSimProfile::TalonFXSimProfile(
    hardware::TalonFX& talonFX, units::kilogram_square_meter_t rotorInertia)
    : _motorSim{frc::LinearSystemId::DCMotorSystem(
                    frc::DCMotor::KrakenX60FOC(1), rotorInertia, 1),
...
void TalonFXSimProfile::Run() {
  ...
  _talonFXSim.SetSupplyVoltage(12_V - _talonFXSim.GetSupplyCurrent() *
                                          kMotorResistance);
}