...
void Robot::DisabledInit() {
  m_container.leds.SetDisabledMode();  // Disabling led
}
>>>>>>> 8394ba223b5e8a3b4cfd9cf0088030449f572aad
...
<<<<<<< HEAD
  m_container.leds.SetAutonomousMode();
=======
...
<<<<<<< HEAD
  m_container.leds.SetTeleopMode();
=======
